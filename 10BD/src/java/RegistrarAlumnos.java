...
public class RegistrarAlumnos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body class='bg-dark text-secondary px-4 py-5 text-center'>");
            ...
            try{
                ...
                set.executeUpdate(q);
                out.println("<h1 class='titulo'>Alumno Registrado con Exito</h1>");
                ...
                System.out.println(e.getMessage());
                System.out.println(e.getStackTrace());
                out.println("<h1 class='titulo'>Alumno No se pudo Registrar, hay un error</h1>");
            ...
            out.println("<button class='btn btn-outline-info btn-lg px-4 me-sm-3 fw-bold'><a href='ConsultarAlumnos' >Consultar Alumnos</a></button>");
            out.println("</body>");
            out.println("</html>");
        }
    }
