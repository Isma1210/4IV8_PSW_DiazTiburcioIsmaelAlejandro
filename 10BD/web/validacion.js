function validar(){
    ...
    if(formulario.nombre.value.length < 2){
        alert("Escriba por lo menos 2 Caracteres para el nombre");
    ...
    if(!allValido){
        alert("Escriba unicamente letras en los campos de los datos del nombre completo");
        return false;
    }
    ...
    if(formulario.boleta.value.length < 10){
        alert("Escriba los 10 carácteres de su boleta");
        formulario.nombre.focus();
        return false;
    }
    ...
    if(formulario.telefono.value.length < 10){
        alert("Escriba los 10 digitos de su número telefónico");
        formulario.nombre.focus();
        return false;
    }
